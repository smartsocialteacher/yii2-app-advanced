...
<div class='box box-info'>
    ...
    <p>
        <?= Html::a(Yii::t('person', 'Update'), ['update', 'id' => $model->edu_class_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('person', 'Delete'), ['delete', 'id' => $model->edu_class_id], [
