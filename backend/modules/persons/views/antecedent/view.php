...
$this->title = $model->antecedent_id;
...
<div class='box box-info'>
    ...
    <p>
        <?= Html::a(Yii::t('person', 'Update'), ['update', 'id' => $model->antecedent_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('person', 'Delete'), ['delete', 'id' => $model->antecedent_id], [
