  ...
  <body>
    ...
    <div id="tf-about">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="<?=$asset->baseUrl?>/assets/img/02.png" class="img-responsive">
                </div>
                <div class="col-md-6">
        ...
        <div class="overlay">
            <div class="container">
                ...
                <div id="team" class="owl-carousel owl-theme row">
                    <div class="item">
                        <div class="thumbnail">
                            <img src="<?=$asset->baseUrl?>/assets/img/team/01.jpg" alt="..." class="img-circle team-img">
                            <div class="caption">
                                <h3>Jenn Gwapa</h3>
                                <p>CEO / Founder</p>
                    ...
                    <div class="item">
                        <div class="thumbnail">
                            <img src="<?=$asset->baseUrl?>/assets/img/team/02.jpg" alt="..." class="img-circle team-img">
                            <div class="caption">
                                <h3>Jenn Gwapa</h3>
                                <p>CEO / Founder</p>
                                <p>Do not seek to change what has come before. Seek to create that which has not.</p>
                    ...
                    <div class="item">
                        <div class="thumbnail">
                            <img src="<?=$asset->baseUrl?>/assets/img/team/03.jpg" alt="..." class="img-circle team-img">
                            <div class="caption">
                                <h3>Jenn Gwapa</h3>
                                <p>CEO / Founder</p>
                                <p>Do not seek to change what has come before. Seek to create that which has not.</p>
                    ...
                    <div class="item">
                        <div class="thumbnail">
                            <img src="<?=$asset->baseUrl?>/assets/img/team/04.jpg" alt="..." class="img-circle team-img">
                            <div class="caption">
                                <h3>Jenn Gwapa</h3>
                                <p>CEO / Founder</p>
                                <p>Do not seek to change what has come before. Seek to create that which has not.</p>
        ...
        <div class="overlay">
            <div class="container">
                ...
                <div id="clients" class="owl-carousel owl-theme">
                    <div class="item">
                        <img src="<?=$asset->baseUrl?>/assets/img/client/01.png">
                    </div>
                    <div class="item">
                        <img src="<?=$asset->baseUrl?>/assets/img/client/02.png">
                    </div>
                    <div class="item">
                        <img src="<?=$asset->baseUrl?>/assets/img/client/03.png">
                    </div>
                    <div class="item">
                        <img src="<?=$asset->baseUrl?>/assets/img/client/04.png">
                    </div>
                    <div class="item">
                        <img src="<?=$asset->baseUrl?>/assets/img/client/05.png">
                    </div>
                    <div class="item">
                        <img src="<?=$asset->baseUrl?>/assets/img/client/06.png">
                    </div>
                    <div class="item">
                        <img src="<?=$asset->baseUrl?>/assets/img/client/07.png">
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#">
                                ...
                                <img src="<?=$asset->baseUrl?>/assets/img/portfolio/01.jpg" class="img-responsive" alt="...">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#">
                                ...
                                <img src="<?=$asset->baseUrl?>/assets/img/portfolio/02.jpg" class="img-responsive" alt="...">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#">
                                ...
                                <img src="<?=$asset->baseUrl?>/assets/img/portfolio/03.jpg" class="img-responsive" alt="...">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#">
                                ...
                                <img src="<?=$asset->baseUrl?>/assets/img/portfolio/04.jpg" class="img-responsive" alt="...">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#">
                                ...
                                <img src="<?=$asset->baseUrl?>/assets/img/portfolio/05.jpg" class="img-responsive" alt="...">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#">
                                ...
                                <img src="<?=$asset->baseUrl?>/assets/img/portfolio/06.jpg" class="img-responsive" alt="...">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#">
                                ...
                                <img src="<?=$asset->baseUrl?>/assets/img/portfolio/07.jpg" class="img-responsive" alt="...">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#">
                                ...
                                <img src="<?=$asset->baseUrl?>/assets/img/portfolio/08.jpg" class="img-responsive" alt="...">
                            </a>
                        </div>
                    </div>
                </div>
