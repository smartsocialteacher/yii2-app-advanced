...
<!--    <meta charset="utf-8">
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="<?=$asset->baseUrl?>/assets/images/ico/favicon.ico">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="<?=$asset->baseUrl?>/assets/images/logo.png" alt="logo" height="40"></a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="<?=$asset->baseUrl?>/assets/images/main-feature.png" alt="">
                </div>
                <div class="col-sm-6">
                    ...
                    <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <p><img class="img-circle img-thumbnail" src="<?=$asset->baseUrl?>/assets/images/testimonial/01.jpg" alt=""></p>
            ...
            <div class="row">
                        ...
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img class="img-responsive" src="<?=$asset->baseUrl?>/assets/images/blog/01.jpg" alt="">
                ...
                <div class="col-sm-6">
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="<?=$asset->baseUrl?>/assets/images/blog/02.jpg" alt="">
                    ...
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="200ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="<?=$asset->baseUrl?>/assets/images/blog/03.jpg" alt="">
